# vue3-moment
[![npm version](https://badge.fury.io/js/vue3-moment.svg)](https://badge.fury.io/js/vue3-moment)
[![Build Status](https://travis-ci.org/brockpetrie/vue3-moment.svg?branch=master)](https://travis-ci.org/brockpetrie/vue3-moment)
[![Monthly Downloads](https://img.shields.io/npm/dm/vue3-moment.svg)](https://www.npmjs.com/package/vue3-moment)
...
```sh
npm install @types/vue3-moment --save-dev
```
or
```sh
...
`vue3-moment` should respect any global Moment customizations, including i18n locales. For more info, check out <http://momentjs.com/docs/#/customization/>.
...
`vue3-moment` attaches the momentjs instance to your Vue app as `this.$moment`.
